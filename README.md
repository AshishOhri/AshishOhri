...
- 👯 I’m looking to collaborate on great projects and on kaggle competitions.
- 💬 Ask me anything.
- ⚡ Fun fact: I love playing chess!

### Tools, languages and technologies
![Python](https://img.shields.io/static/v1?label=&message=Python&color=black&logo=python)
![Jupyter](https://img.shields.io/static/v1?label=&message=Jupyter&color=817dfa&logo=jupyter)
![Scikit-Learn](https://img.shields.io/static/v1?label=&message=Scikit-Learn&color=71eb73&logo=scikit-learn)
![Matplotlib](https://img.shields.io/static/v1?label=&message=Matplotlib&color=1c308a&logo=matplotlib)
![Pandas](https://img.shields.io/static/v1?label=&message=pandas&color=black&logo=pandas)
![Numpy](https://img.shields.io/static/v1?label=&message=Numpy&color=91f27e&logo=numpy)
![Pytorch](https://img.shields.io/static/v1?label=&message=Pytorch&color=black&logo=pytorch)
![OpenCV](https://img.shields.io/static/v1?label=&message=OpenCV&color=5985ff&logo=opencv)
![Beautiful Soup](https://img.shields.io/static/v1?label=&message=BeautifulSoup&color=817dfa&logo=beautifulsoup)
![Selenium](https://img.shields.io/static/v1?label=&message=Selenium&color=4588d9&logo=selenium)
![C++](https://img.shields.io/static/v1?label=&message=Cpp&color=1c308a&logo=C)
![Github](https://img.shields.io/static/v1?label=&message=Github&color=black&logo=github)
![HTML](https://img.shields.io/static/v1?label=&message=HTML&color=1c518a&logo=html5)
![CSS](https://img.shields.io/static/v1?label=&message=CSS&color=526cff&logo=css3)
![Bootstrap](https://img.shields.io/static/v1?label=&message=Bootstrap&color=ff832b&logo=bootstrap)
![Arduino Programming](https://img.shields.io/static/v1?label=&message=ArduinoProgramming&color=1c518a&logo=arduino) 
![Java](https://img.shields.io/static/v1?label=&message=Java&color=blue&logo=java)
...
![visitors](https://visitor-badge.glitch.me/badge?page_id=ashishohri)
